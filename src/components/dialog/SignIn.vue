<template>
  <v-dialog v-model="$store.getters.ui.dialog.signIn" content-class="dialog" persistent>
    <v-card tile>
      <v-form @submit.prevent="signIn">
        <v-card-title class="display-1 font-weight-black text-center">Sign In</v-card-title>
        <v-card-text>
        ...
        <v-card-actions>
          ...
          <v-btn text tile color="green darken-1" @click="signIn">Sign In</v-btn>
        </v-card-actions>
      </v-form>
    </v-card>
  </v-dialog>
